...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      [:experiments_tab, "Experiments", experiments_path, true, true],
      [:samples_tab, "Samples", samples_path, true, true],
  ...
  config.actions do
    [
      ...
      [:registrations, :all_actions, :users_tab],
      [:sessions, :all_actions, :users_tab],
      [:experiments, :all_actions, :experiments_tab],
      [:samples, :all_actions, :samples_tab]
    ]
  end
